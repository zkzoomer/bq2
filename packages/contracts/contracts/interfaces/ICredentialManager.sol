...
interface ICredentialManager is ICredentialHandler, IERC165 {
    ...
    event CredentialsGained(uint256 indexed credentialId, uint256 indexed identityCommitment, uint256 gradeCommitment);
    ...
    /// @param gradeCommitment: new grade commitment added to the grade tree
    event CredentialsNotGained(uint256 indexed credentialId, uint256 indexed identityCommitment, uint256 gradeCommitment);
